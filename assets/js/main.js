    ...
    console.log(`Количество замерзаний ${frozen}`);
    ...
    */
    ...
    for(let i = 0; i < winterDays.length - 1; i++){
        ...
        /*console.log(`Количество дней заморозков ${frozen}`);*/
            ...
            frozen = 1;
        }if (frozen > maxcounter){
            maxcounter = frozen;
        }
        
    }
    console.log(`Max количество дней заморозков ${maxcounter}`);
